...
export LIBS="-lfftw3 -lgsl -lmpi -lmpicxx -lgslcblas -llapack -lblas -lz $LIBS"
...
#./configure --prefix=$PREFIX --disable-python --disable-libsearch --disable-static-patch --disable-static-archive --enable-mpi --enable-modules=all
./configure --prefix=$PREFIX --enable-modules=all CXX=mpicxx CC=mpicc
